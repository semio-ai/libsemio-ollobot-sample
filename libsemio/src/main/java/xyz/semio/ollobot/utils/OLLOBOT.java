package xyz.semio.ollobot.utils;
...
public class OLLOBOT {
	...
	public class Address {
		public static final int GREEN_LED = 79;
		public static final int BLUE_LED = 80;
		public static final int INPUT_POWER_VOLTAGE = 97;
		public static final int CONTROLLER_X_AXIS_VALUE = 112;
		public static final int CONTROLLER_Y_AXIS_VALUE = 113;
		public static final int PORT_1_SERVO_MODE = 128; // LEFT
		public static final int PORT_2_SERVO_MODE = 129; // RIGHT
		public static final int PORT_1_MOTOR_SPEED = 136;
		public static final int PORT_2_MOTOR_SPEED = 138;
		public static final int PORT_1_SERVO_POSITION = 156;
		public static final int PORT_2_SERVO_POSITION = 158;
	}
